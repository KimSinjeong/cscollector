...
#
# _use_slots = True:   Memory efficient and faster in modern Python (default)
# _use_slots = False:  Ordinary classes, much faster than slots in Python 2.4
#                      and 2.5
_use_slots = True
...
class Geometry:
    def _connect_unimplemented(self, other):
        raise AttributeError('Cannot connect {} to {}'.format(self.__class__, other.__class__))

    def _intersect_unimplemented(self, other):
        raise AttributeError('Cannot intersect {} and {}'.format(self.__class__, other.__class__))
